...
class CartSerializer(serializers.ModelSerializer):
     ...
     class Meta:
          model = Cart
          fields = ['id', 'items', 'total_price'] #we don't need to return 'created_at', since it's only use for maintanance at the db
...
class UodateOrderSerializer(serializers.ModelSerializer):
     class Meta:
          model = Order
